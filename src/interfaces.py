...
class InputData(BaseModel):
    ...
    Race: int = Field(
        ..., ge=1, le=5, description="1=Mex, 2=Other Hisp, 3=White, 4=Black, 5=Other"
    )
    ...
    DiastolicBP: Optional[float] = Field(
        None, ge=40, le=120, description="Diastolic Blood Pressure (mmHg)"
    )
    ...
    ALT_Enzyme: float = Field(
        ..., ge=5, le=200, description="Alanine Aminotransferase (U/L)"
    )
    AST_Enzyme: float = Field(
        ..., ge=5, le=200, description="Aspartate Aminotransferase (U/L)"
    )
    GGT_Enzyme: float = Field(
        ..., ge=5, le=200, description="Gamma-Glutamyl Transferase (U/L)"
    )
    ...
    Alcohol: int = Field(
        ..., ge=0, le=1, description="Frequent alcohol consumption? (0/1)"
    )
    PhysicalActivity: int = Field(
        ..., ge=0, le=1, description="Vigorous physical activity? (0/1)"
    )
    HealthInsurance: int = Field(
        ..., ge=0, le=1, description="Has health insurance? (0/1)"
    )
