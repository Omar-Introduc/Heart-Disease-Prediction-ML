...
def get_robust_code():
    return [
        ...
        "             # Average over calibrated classifiers\n",
        "             imps = [get_model_importance(clf.base_estimator) for clf in model.calibrated_classifiers_]\n",
...
if os.path.exists(notebook_path):
    ...
    if target_cell:
        print("Updating cell logic...")
        # Completely replace the source with the new robust logic
        target_cell['source'] = get_robust_code() + [
        ...
        print("Notebook updated with robust logic.")
