...
def update_notebook(filepath):
    ...
    for cell in nb['cells']:
        if cell['cell_type'] == 'markdown' and cell['source'][0].startswith("## 1. Carga"):
            cell['source'] = [
    ...
    for cell in nb['cells']:
        if cell['cell_type'] == 'markdown' and cell['source'][0].startswith("## 2. Validación"):
            cell['source'] = [
    ...
    for cell in nb['cells']:
        if cell['cell_type'] == 'markdown' and cell['source'][0].startswith("## 3. Análisis"):
            cell['source'] = [
    ...
    for cell in nb['cells']:
        if cell['cell_type'] == 'markdown' and cell['source'][0].startswith("## 4. Reporte"):
            cell['source'] = [
